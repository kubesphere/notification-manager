...
kubectl apply -f https://github.com/kubesphere/notification-manager/releases/download/v2.7.0/bundle.yaml
# Deploy default template:
kubectl apply -f https://github.com/kubesphere/notification-manager/releases/download/v2.7.0/template.yaml
# Deploy built-in language packs.
kubectl apply -f https://github.com/kubesphere/notification-manager/releases/download/v2.7.0/zh-cn.yaml
```

#### Install with helm

```shell
helm install notification-manager --create-namespace -n kubesphere-monitoring-system https://github.com/kubesphere/notification-manager/releases/download/v2.7.0/notification-manager.tgz
```
...
```shell
kubectl apply -f https://github.com/kubesphere/notification-manager/releases/download/v2.7.0/notification_manager.yaml
```
