...
// +kubebuilder:rbac:groups=notification.kubesphere.io,resources=notificationmanagers,verbs=get;list;watch;create;update;patch;delete
...
func (r *NotificationManagerReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	...
	_ = r.Log.WithValues("notificationmanager", req.NamespacedName)
...
func (r *NotificationManagerReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&notificationv1alpha1.NotificationManager{}).
		Complete(r)
}
